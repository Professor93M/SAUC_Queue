    ...
    return (
        <Visitor classes="print:w-20 print:h-20 w-40 h-40">
            <div
                ...
                style={{ height: "78vh" }}
            >
                <h3 class="text-4xl align-middle">
                    {" "}
                    تسلسل المراجع رقم :{" "}
                ...
                <div class="flex justify-around  w-96">
                    <h3 class="text-7xl space-y-2">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="55"
                            height="55"
                            fill="currentColor"
                            class="bi bi-person-square my-3 mx-auto"
                            viewBox="0 0 16 16"
                        >
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                            <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-1c0-1-1-4-6-4s-6 3-6 4v1a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12z" />
                        </svg>
                        <span class="text-red-500 font-bold bg-gray-200 border-2 rounded-lg px-4 text-6xl">
                            {emp.name}
                        </span>
                    </h3>
                    <h3 class="text-7xl space-y-2">
                        <svg
                            ...
                            height="55"
                            fill="currentColor"
                            class="bi bi-pc-display-horizontal my-3 mx-auto"
                            viewBox="0 0 16 16"
                        >
                            <path
                                fill-rule="evenodd"
